...
ss_filepath = path+"/../../ss_lists/"+pdb+"_ss.txt" 
...
def concatenate_data(exp, md, combined_path, ss_filepath):
    """
    ...
    with open(combined_path, "w") as f:
        ...
        for residue in common_residues:
            ...
            line = str(residue) + "\t" + datastr + "\t" + ss_info + "\t" + str(rel_err_N) + "\t" + str(rel_err_H) + "\t" + str(rel_err_C)  + "\n"
