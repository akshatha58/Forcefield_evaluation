...
def doframes(framerange):
    ...
    for _ in u.trajectory[start:end]:
        ...
        # print(dump.process_frame(u, residues, prot, notH))
...
if __name__ == '__main__':
    ...
    if args.inputdir:
        ...
        # Print first 5 atom coordinates in the first frame
        # print("First 5 atom coordinates in the first frame:")
        # print(u.atoms.positions[:5])
        
        # Iterate over the first 5 frames and print coordinates
        ...
        # DEBUG CODE STARTS HERE
        # print("Protein atom coordinates in the first frame:")
        # print(prot.positions[:5])
        # print("Non-hydrogen atom coordinates in the first frame:")
        # print(notH.positions[:5])
        # DEBUG CODE ENDS HERE
